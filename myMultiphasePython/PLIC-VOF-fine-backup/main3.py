...
while t < T:
    ...
    #nx, ny = nxy.calcnxy(dx, dy, Cstar)
    #C_nplus1 = propagation.calcC_nplus1(nx, ny, u, v, dt, dx, dy, alpha, x, y, Cstar) #Cstar改为C
    C_nplus1 = propagation.calcC_nplus1(nx, ny, u, v, dt, dx, dy, alpha, x, y, C)

    #C = C_nplus1.copy()
    C = C_nplus1.copy()  # 用于测试
    t = t + dt
